...
" interactive file browser. Version for Unix.                                "
"                                                                            "
" MAPS:                                                                      "
"                                                                            "
"    ,d    Open the browser                                                  "
...
"
" -----------------------------------------------------------------------------
map ,d :call FilebrowserOpen()<cr>
" ----------------------------------------------------------------------------- 
if !exists("_filebrwsu_vim_sourced")
let _filebrwsu_vim_sourced=1
" ----------------------------------------------------------------------------- 
so ~/buffun.vim
so ~/fun.vim
so ~/strfun.vim
...
fu! FilebrowserDir(...)
  ...
  exe g:bufclear
  if g:filebrowser_dirpat=="*"
    let g:filebrowser_dirpat=""
  endif
  exe "r !ls -l ".g:filebrowser_dirpat
  exe "3"
  exe "w!"
  set ch=1
  exe "3"
...
aug filebrowser
  ...
  au bufenter _dir map w W
  au bufleave _dir unm w
